...
export class TasksWidget {
    ...
    saveData() {
        ...
        let data = {type: this.type, widgetId: this.widgetId, title: this.title, tasks: this.tasks, xPos: this.xPos, yPos: this.yPos, anchorX: this.anchorX, anchorY: this.anchorY}
        console.log(data)
